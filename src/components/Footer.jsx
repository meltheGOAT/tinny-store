...
export default function Footer() {
  ...
  const handleSubscribe = e => {
    ...
    if (email.trim()) {
      showToast(
        "Subscribed to TINNY Abuja private drop notifications.",
        "success",
      );
      setEmail("");
    }
      ...
      <div className="footer-inner-grid">
        ...
        <div>
          ...
          >
            ...
            <li>
              <span> Same-Day Delivery (Abuja)</span>
            </li>
            <li>
              <a
            ...
            <li>
              <span>14-Day Boutique Exchanges</span>
            </li>
            <li>
        ...
        <div>
          ...
          >
            Be first to access limited seasonal releases and members-only
            restocks in Abuja.
          </p>
          <form
